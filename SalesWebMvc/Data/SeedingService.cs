...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Charlotte", "Charlotte@gmail.com", new DateTime(2017, 4, 05), 2000.0, d1);
            Seller s3 = new Seller(3, "Chloe Grey", "Chloe_Grey@gmail.com", new DateTime(2020, 10, 31), 2000.0, d3);
            Seller s4 = new Seller(4, "Zé Max", "Max@gmail.com", new DateTime(2016, 08, 01), 2500.0, d4);
            ...
            SalesRecord r1 = new SalesRecord(1, new DateTime(2021, 01, 02), 850.0, SaleStatus.Billed, s2);
            SalesRecord r2 = new SalesRecord(2, new DateTime(2021, 01, 03), 920.0, SaleStatus.Canceled, s2);
            SalesRecord r3 = new SalesRecord(3, new DateTime(2021, 01, 02), 750.0, SaleStatus.Pending, s1);
            SalesRecord r4 = new SalesRecord(4, new DateTime(2021, 01, 03), 1020.0, SaleStatus.Billed, s4);
            SalesRecord r5 = new SalesRecord(5, new DateTime(2021, 01, 07), 5000.0, SaleStatus.Billed, s3);
